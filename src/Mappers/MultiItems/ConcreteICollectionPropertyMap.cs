...
namespace ExcelMapper.Mappers.MultiItems
{
    /// <summary>
    ...
    internal class ConcreteICollectionPropertyMap<T> : EnumerableExcelPropertyMap<T>
    {
        ...
        public ConcreteICollectionPropertyMap(Type type, MemberInfo member, ValuePipeline<T> elementMapping) : base(member, elementMapping)
        {
            CollectionType = type;
        }
