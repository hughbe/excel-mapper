...
public class ExcelColumnMatchingAttribute : Attribute
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of <see cref="ExcelColumnMatchingAttribute"/> with the specified regex matcher.
    /// </summary>
