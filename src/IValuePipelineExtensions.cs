...
public static class IValuePipelineExtensions
{
    ...
    /// <returns>The property map on which this method was invoked.</returns>
    public static TPropertyMap WithCellValueMappers<TPropertyMap>(this TPropertyMap propertyMap, params ICellMapper[] mappers) where TPropertyMap : IValuePipeline
    {
        if (mappers == null)
        {
