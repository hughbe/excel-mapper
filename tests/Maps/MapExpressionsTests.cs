...
#pragma warning disable xUnit2013 // Do not use equality check to check for collection size.
    ...
    public void ReadRow_DefaultMapped_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<SimpleClass>(c =>
        {
            c.Map(o => o.Value);
        });
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<MultiplePropertiesNestedClassParent>(c =>
        {
            c.Map(o => o.Child.Column2);
            c.Map(o => o.Child.Column3);
        });
        var sheet = importer.ReadSheet();
        sheet.ReadHeading();
    ...
    {
        using var importer = Helpers.GetImporter("Numbers.xlsx");
        importer.Configuration.RegisterClassMap<NestedGrandParent>(c =>
        {
            c.Map(o => o.Parent.Child.Value);
        });
        var sheet = importer.ReadSheet();
        sheet.ReadHeading();
    ...
    public void ReadRows_CustomMappedCastIntArrayIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<IntArrayClass>(c =>
        {
            c.Map(o => o.Values[(int)0])
                .WithColumnName("Column2");
            c.Map(o => o.Values[(int)1])
                .WithColumnName("Column3");
        });
    ...
    public void ReadRows_DefaultMappedObjectMemberArrayIndex_Success()
    {
        ...
        {
            c.Map(o => o.Values[0].Value);
            c.Map(o => o.Values[1].Value);
        });
    ...
    public void ReadRows_DefaultMappedObjectMemberArrayIndexMultipleFields_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<ObjectArrayMultipleFieldsClass>(c =>
        {
            c.Map(o => o.Values[0].Column1);
            c.Map(o => o.Values[0].Column2);
            c.Map(o => o.Values[1].Column1);
            c.Map(o => o.Values[1].Column2);
        });
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<IntArrayArrayClass>(c =>
        {
            c.Map(o => o.Values[0][0]);
            c.Map(o => o.Values[0][1]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<IntArrayMultidimensionalArrayClass>(c =>
        {
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<IntArrayIndexListIndex>(c =>
        {
            c.Map(o => o.Values[0][0]);
            c.Map(o => o.Values[0][1]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<IntArrayIndexDictionaryIndex>(c =>
        {
            c.Map(o => o.Values[0]["Column2"]);
            c.Map(o => o.Values[0]["Column3"]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ArrayIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values[0][0].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[1][0].Value)
                .WithColumnName("Column3");
        });
    ...
    public void ReadRows_DefaultMappedObjectMemberArrayIndexArrayIndexBoth_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<ArrayIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values[1][2].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[3][4].Value)
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ArrayIndexListIndexClass>(c =>
        {
            c.Map(o => o.Values[0][0].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[0][1].Value)
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ArrayIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values[0]["Column2"].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[0]["Column3"].Value)
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ArrayIndexArrayIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values[0][0][0].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[0][1][0].Value)
                .WithColumnName("Column3");
        });
    ...
    public void Map_DefaultMappedIntMultidimensionalArrayValue_Success()
    {
        ...
        {
            c.Map(p => p.Values[0, 0]);
            c.Map(p => p.Values[0, 1]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<ObjectMultidimensionalArrayClass>(c =>
        {
            c.Map(o => o.Values[0, 0].Value)
                .WithColumnName("NoSuchColumn");
            c.Map(o => o.Values[0, 0].Value)
    ...
    public void Map_DefaultMappedObjectMultidimensionalArrayValue_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<ObjectMultidimensionalArrayClass>(c =>
        {
            c.Map(p => p.Values[0, 0].Value);
            c.Map(p => p.Values[0, 1].Value);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ObjectMultidimensionalArrayMultipleFieldsClass>(c =>
        {
            c.Map(p => p.Values[0, 0].Column1);
            c.Map(p => p.Values[0, 0].Column2);
            c.Map(p => p.Values[0, 1].Column1);
            c.Map(p => p.Values[0, 1].Column2);
        });
    ...
    public void Map_CustomMappedObjectMultidimensionalArrayValueMultipleFields_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<ObjectMultidimensionalArrayMultipleFieldsClass>(c =>
        {
            ...
            c.Map(p => p.Values[0, 1].Column2)
                .WithColumnName("Column5");
            c.Map(p => p.Values[2, 3].Column1)
                .WithColumnName("Column6");
            c.Map(p => p.Values[2, 3].Column2)
    ...
    {
        using var importer = Helpers.GetImporter("DictionaryIntMap.xlsx");
        importer.Configuration.RegisterClassMap<ObjectListClass>(c =>
        {
            c.Map(o => o.Values[0].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[1].Value)
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ObjectListMultipleFieldsClass>(c =>
        {
            c.Map(o => o.Values[0].Column1);
            c.Map(o => o.Values[0].Column2);
            c.Map(o => o.Values[1].Column1);
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ArrayIndexListIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values[0][0][0].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[0][1][0].Value)
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ArrayIndexArrayIndexListIndexClass>(c =>
        {
            c.Map(o => o.Values[0][0][0].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[0][1][0].Value)
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ListIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values[0]["Column2"].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values[0]["Column3"].Value)
    ...
    public void ReadRows_DefaultMappedDictionaryIndex_Success()
    {
        ...
        {
            c.Map(o => o.Values["Column2"]);
            c.Map(o => o.Values["Column3"]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryClass>(c =>
        {
            c.Map(o => o.Values["key2"])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key3"])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ObjectDictionaryClass>(c =>
        {
            c.Map(o => o.Values["Column2"].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Values["Column3"].Value)
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ObjectDictionaryMultipleFieldsClass>(c =>
        {
            c.Map(o => o.Values["key1"].Column1);
            c.Map(o => o.Values["key1"].Column2);
            c.Map(o => o.Values["key2"].Column1);
            c.Map(o => o.Values["key2"].Column2);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values["Column2"][0]);
            c.Map(o => o.Values["Column3"][1]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndexArrayIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values["key2"][0])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key3"][1])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexMultidimensionalIndexClass>(c =>
        {
            c.Map(o => o.Values["Column2"][0, 1]);
            c.Map(o => o.Values["Column3"][2, 3]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndexMultidimensionalIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryIndexMultidimensionalIndexClass>(c =>
        {
            c.Map(o => o.Values["key2"][0, 1])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key3"][2, 3])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexListIndexClass>(c =>
        {
            c.Map(o => o.Values["Column2"][0]);
            c.Map(o => o.Values["Column3"][1]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"]["Column2"]);
            c.Map(o => o.Values["key2"]["Column3"]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndexDictionaryIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key2"]["key3"])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key4"]["key5"])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexArrayIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"][0][1]);
            c.Map(o => o.Values["key3"][2][3]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexArrayIndexListIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"][0][1]);
            c.Map(o => o.Values["key3"][2][3]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexArrayIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"][0]["Column2"]);
            c.Map(o => o.Values["key3"][1]["Column3"]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndexArrayIndexDictionaryIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryIndexArrayIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key2"][0]["key4"])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key5"][1]["key7"])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexListIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"][0][1]);
            c.Map(o => o.Values["key3"][2][3]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexListIndexListIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"][0][1]);
            c.Map(o => o.Values["key3"][2][3]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexListIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"][0]["Column2"]);
            c.Map(o => o.Values["key3"][1]["Column3"]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"]["key2"][0]);
            c.Map(o => o.Values["key3"]["key4"][1]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndexDictionaryIndexArrayIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexArrayIndexClass>(c =>
        {
            c.Map(o => o.Values["key2"]["key3"][0])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key5"]["key6"][1])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexListIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"]["key2"][0]);
            c.Map(o => o.Values["key3"]["key4"][1]);
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key1"]["key2"]["Column2"]);
            c.Map(o => o.Values["key3"]["key4"]["Column3"]);
        });
    ...
    public void ReadRows_CustomMappedDictionaryIndexDictionaryIndexDictionaryIndex_Success()
    {
        ...
        importer.Configuration.RegisterClassMap<DictionaryIndexDictionaryIndexDictionaryIndexClass>(c =>
        {
            c.Map(o => o.Values["key2"]["key3"]["key4"])
                .WithColumnName("Column2");
            c.Map(o => o.Values["key5"]["key6"]["key7"])
                .WithColumnName("Column3");
        });
    ...
    {
        using var importer = Helpers.GetImporter("ExpressionsMap.xlsx");
        importer.Configuration.RegisterClassMap<ComplexChainClass1>(c =>
        {
            c.Map(o => o.Value.Values[0].Value.Values[0].Value.Values["key1"].Value.Value[0, 0].Value)
                .WithColumnName("Column1");
            c.Map(o => o.Value.Values[0].Value.Values[0].Value.Values["key2"].Value.Value[0, 1].Value)
                .WithColumnName("Column2");
            c.Map(o => o.Value.Values[0].Value.Values[1].Value.Values["key1"].Value.Value[1, 0].Value)
                .WithColumnName("Column3");
            c.Map(o => o.Value.Values[0].Value.Values[1].Value.Values["key2"].Value.Value[1, 1].Value)
                .WithColumnName("Column4");
            c.Map(o => o.Value.Values[1].Value.Values[0].Value.Values["key1"].Value.Value[0, 0].Value)
                .WithColumnName("Column5");
            c.Map(o => o.Value.Values[1].Value.Values[0].Value.Values["key2"].Value.Value[0, 1].Value)
                .WithColumnName("Column6");
            c.Map(o => o.Value.Values[1].Value.Values[1].Value.Values["key1"].Value.Value[1, 0].Value)
                .WithColumnName("Column7");
            c.Map(o => o.Value.Values[1].Value.Values[1].Value.Values["key2"].Value.Value[1, 1].Value)
