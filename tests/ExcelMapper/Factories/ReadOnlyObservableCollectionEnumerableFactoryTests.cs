...
public class ReadOnlyObservableCollectionEnumerableFactoryTests
{
    ...
    public void Begin_End_Success()
    {
        ...
        // Begin again.
        factory.Begin(1);
        value = Assert.IsType<ReadOnlyObservableCollection<int>>(factory.End());
        Assert.Equal([], value);
    }
    ...
    public void Set_Invoke_Success()
    {
        ...
        factory.Set(0, 1);
        Assert.Equal([1], Assert.IsType<ReadOnlyObservableCollection<int>>(factory.End()));
    }
    ...
    public void Set_InvokeOutOfRange_Success()
    {
        ...
        factory.Set(0, 1);
        factory.Set(5, 2);
        Assert.Equal([1, 0, 0, 0, 0, 2], Assert.IsType<ReadOnlyObservableCollection<int>>(factory.End()));
    }
