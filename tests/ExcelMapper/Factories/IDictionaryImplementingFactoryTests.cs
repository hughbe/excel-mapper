...
public class IDictionaryImplementingFactoryTests
{
    [Theory]
    ...
    public void Begin_End_Success()
    {
        ...
        // Begin.
        factory.Begin(1);
        var value = Assert.IsType<Hashtable>(factory.End());
        Assert.Equal([], value);

        // Begin again.
        factory.Begin(1);
        value = Assert.IsType<Hashtable>(factory.End());
        Assert.Equal([], value);
    }
    ...
    public void Add_End_Success()
    {
        ...
        factory.Add("key", 1);
        var value = Assert.IsType<Hashtable>(factory.End());
        Assert.Equal(new Hashtable { ["key"] = 1 }, value);

        // Begin again.
        factory.Begin(1);
        factory.Add("key", 2);
        value = Assert.IsType<Hashtable>(factory.End());
        Assert.Equal(new Hashtable { ["key"] = 2 }, value);
    }
    ...
    public void Add_OutOfRange_Success()
    {
        ...
        var value = Assert.IsType<Hashtable>(factory.End());
        Assert.Equal(new Hashtable { ["key1"] = 2, ["key2"] = 3 }, value);
    }
