...
public class ImmutableListEnumerableFactoryTests
{
    [Fact]
    public void Begin_End_Success()
    {
        ...
        // Begin.
        factory.Begin(1);
        var value = Assert.IsType<ImmutableList<int>>(factory.End());
        Assert.Equal([], value);

        // Begin again.
        factory.Begin(1);
        value = Assert.IsType<ImmutableList<int>>(factory.End());
        Assert.Equal([], value);
    }
